...
export class LanguageStringSchema extends BaseStringSchema<At.LanguageCode> {
	override readonly format = 'language';

	override func(value: unknown, context: ValidateContext): ValidateResult<At.LanguageCode> {
